...
cv2.createTrackbar("Upper Hue", "Color detect", 153, 180, setValues)
cv2.createTrackbar("Upper Saturation", "Color detect", 255, 255, setValues)
cv2.createTrackbar("Upper Value", "Color detect", 255, 255, setValues)
cv2.createTrackbar("Lower Hue", "Color detect", 64, 180, setValues)
cv2.createTrackbar("Lower Saturation", "Color detect", 72, 255, setValues)
cv2.createTrackbar("Lower Value", "Color detect", 49, 255, setValues)
...
while True:
    ...
    u_hue = cv2.getTrackbarPos("Upper Hue", "Color detect")
    u_saturation = cv2.getTrackbarPos("Upper Saturation", "Color detect")
    u_value = cv2.getTrackbarPos("Upper Value", "Color detect")
    l_hue = cv2.getTrackbarPos("Lower Hue", "Color detect")
    l_saturation = cv2.getTrackbarPos("Lower Saturation", "Color detect")
    l_value = cv2.getTrackbarPos("Lower Value", "Color detect")
